...
class ModalProductInfo extends Component
{
    ...
    public function render(): View|Closure|string
    {
        $this->contents = [
            ...
            'aftercare' => "Protect your shoes from excess sun or heat, moisture, and harsh cleaning products, including alcohol-based ones. Gently wipe your shoes with a damp cloth, and never wash them in the washing machine.<br><br>
                If you're not wearing a summer collection, do not wear your shoes with bare feet. Always be sure to wear the right socks.<br><br>
                 You can use a shoe polish made for animal-based leather. It works on plant-based leather as well.<br><br>
                    Avoid getting your shoes extremely wet. If they get wet, avoid exposure to direct sunlight or heat sources like radiators. Let them dry at room temperature without closing them in a box.<br><br>
                    When storing your shoes, use a shoe tree or crumpled paper to avoid folding or pressing and to protect the structure.<br><br>
                    Over time, cracks and scratches may occur naturally due to use. This happens because of the nature of all materials.<br><br>
                    The 'one day apart' rule, which is valid for all leather shoes, is also useful for plant-based leather shoes. Wearing your shoes on alternate days will help them last longer and prevent them from smelling.<br><br>
                    Thank you for reading and caring about this guide! We can't wait to take the first steps of the revolution together.
                ",

            'manufacturing' => 'Although with a global mission and vision, Prev is a locally-produced brand that works with a small number of selected ateliers to manufacture its products. When selecting their manufacturing partners, they pay great attention to ensuring that the employees work fair hours and earn at least the minimum wage. They also try their best to work with ateliers that employ female workers.<br>
                Although our commitment to ethical production may cause delays and problems in the production process from time to time, we always put and continue to put ethical production at the forefront. We see informing everyone about these processes as part of supporting ethical production so that our customers can tolerate these delays<br>
