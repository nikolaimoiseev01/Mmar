<main class="flex-1 content flex flex-col gap-8 max-w-5xl">
    ...
    @endsection
    <h1 class="smooth-content mt-12 text-start">Shipping Information</h1>
    <p class="smooth-content">At MMAR, we're dedicated to ensuring your orders reach you safely and on time. Our
        approach to shipping also
    ...
    <div class="smooth-content flex flex-col gap-4  mt-2">
        <x-ui.link-arrow
