    ...
    <section class="flex md:flex-col mb-20 pl-6 md:pl-0 h-screen" id="welcomeSection">
        <div class="w-1/2 md:w-full md:px-6 flex flex-col pt-32 gap-12">
            <p class="font-[Forum] text-2xl leading-relaxed">
                ...
                high-quality design and choices.
            </p>
            <p class="font-[Forum] text-2xl leading-relaxed">
                Our selection will prove that fashion can be a celebration of creativity, art, cultures and respect for
                nature, including the people, the animals and the planet
            </p>
            <x-ui.link-arrow
                href="/about"
