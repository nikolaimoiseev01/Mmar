<main class="flex-1 content">
    ...
    <div class="flex flex-wrap gap-4 mb-20 mx-auto w-fit">
    ...
    <div class="flex flex-col">
        @foreach($blocks as $key=>$block)
            <div id="{{Str::slug($key)}}" class="border-t border-red-100 flex">
                <div class="w-1/2 gap-2 pt-4">
                    <div class="flex gap-2 items-center">
                        <span class="bg-red-700 w-2 h-2 rounded-full block"></span>
