<main class="flex-1">
    ...
    <div class="smooth-content flex flex-wrap gap-4 my-8 mx-auto w-fit justify-center max-w-5xl sm:flex-nowrap sm:flex-row items-center overflow-x-scroll sm:px-4 sm:max-w-full sm:justify-start">
        @foreach($postTopics as $topic)
            <button
                ...
                {{ in_array($topic['id'], $selectedTopics)
                    ? 'bg-red-300 text-bright-200 border-red-400 hover:!text-bright-200'
