<main class="flex-1">
    ...
    <section class="flex mb-52 md:flex-col"
        ...
        chosenSize: null
             ...
             x-init="
        chosenColor = availableOptions[0];
        chosenSize = chosenColor.sizes[0];
    ">
        <div
            class="fixed top-0 left-0 w-full h-full bg-bright-200 z-[60]"
            x-show="open"></div>
        <div
            class="bg-bright-300 w-1/2 md:w-full aspect-square relative"
            ...
            <div
                class="absolute transition top-3 left-3 flex gap-4 z-40">
                <div
                    ...
                    <svg
                        id="product-wishlist-button-{{$product['id']}}"
                        class="wishlist-button w-full"
                        width="17" height="20"
            ...
            <div
                :class="open ? 'product-examples-slider-opened h-screen max-w-max mx-auto sm:h-auto' : ''">
                <x-product-examples-slider
                    :examples="$product->getMedia('examples')"/>
            </div>
        </div>
        <div
            class="smooth-content  flex flex-col pt-20 pl-10 md:pl-6 pr-6 w-1/2 md:w-full md:pt-8">
            <div
                class="w-full flex justify-between items-end flex-wrap">
            ...
            <div class="flex gap-4">
                <div
                    class="flex items-center justify-center w-40 h-12 bg-gray-100 rounded-md border border-gray-300">
                    <button
                    ...
                    <span
                        class="text-xl font-medium text-gray-900 mx-2">
                        {{ $count }}
                    </span>
            ...
            <div
                class="flex flex-wrap gap-8 sm:grid sm:grid-cols-2 sm:gap-4">
                <div
