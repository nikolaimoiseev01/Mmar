<main class="flex-1">
    @section('title')
        Sustainability
    @endsection
    <x-page-title class="mb-12 content">At MMAR, we’re defining the next generation of fashion through the meticulous curation
        of sustainable
        and animal-free products from ethical and innovative brands.
    </x-page-title>
    <p class="mb-24 max-w-2xl  mx-auto">Our mission is to lead the way in making conscious living effortless and more
        inclusive,
        acknowledging the
    ...
    <img src="/fixed/sustainability-1.png" class="content mb-24" alt="">
    <p class="max-w-2xl mb-24 mx-auto">We recognise that every action has a social and environmental impact, and so does the
        ...
        fair for all.</p>
        <div class="mb-24 content flex gap-4">
            <div class="flex-1 bg-bright-400 h-[444px]"></div>
            <div class="flex-1 bg-bright-400 h-[444px]"></div>
        </div>
    <p class="max-w-2xl mx-auto">Balancing the sustainability of traditional materials with modern alternatives, we champion the rise of new
