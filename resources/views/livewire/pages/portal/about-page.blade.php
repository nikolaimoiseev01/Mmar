<main class="flex-1 mx-4">
    @section('title')
        Sustainability
    @endsection
    <x-page-title class="mb-12 content">MMAR emerged from a desire to create a simplified shopping experience tailored
        for fashion enthusiasts who value conscious choices.
    </x-page-title>
    <p class="smooth-content mb-24 max-w-2xl  mx-auto">Our journey began with the goal of combining our love for fashion with a
    ...
    <p class="smooth-content max-w-2xl mb-24 mx-auto">As Palestinians growing up in a western country, we experienced a blend of
    ...
    <x-page-title class="smooth-content mb-12 content">As devoted fashion enthusiasts, shopping was more than a pastime— it was a way
        to express love and bond with our family.
    </x-page-title>
    <p class="smooth-content max-w-2xl mx-auto mb-24">Nearly a decade ago, we embarked on our journey towards a lifestyle free from
        animal
    ...
    <div class="smooth-content flex flex-col gap-4 mb-24 mx-auto items-center w-full max-w-4xl">
        <img src="/fixed/about-2.png" class="mx-auto w-full" alt="">
        <p class="font-bold">Untitled - by Sardinian artist Angelo Maggi</p>
    </div>
    <p class="smooth-content max-w-2xl mx-auto mb-24">If being passionate consumers, immersed in the struggle to balance the desire for
    ...
    <x-page-title class="smooth-content mb-12 content">Redefining Fashion with Creativity, Innovation, and a Deep Commitment to Ethics
        and Sustainability
    </x-page-title>
    <x-carousel/>
</main>
