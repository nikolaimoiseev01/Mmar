<main class="flex-1 mx-4">
    @section('title')
        Sustainability
    @endsection
    <x-page-title class="mb-12 content sm:text-3xl">MMAR emerged from a desire to create a simplified shopping experience tailored
        for fashion enthusiasts who value conscious choices.
    </x-page-title>
    <p class="smooth-content mb-24 sm:mb-10 max-w-2xl  mx-auto sm:text-base">Our journey began with the goal of combining our love for fashion with a
    ...
    <div class="smooth-content flex flex-col gap-4 max-w-md min-w-[448px] sm:min-w-full mb-24 mx-auto sm:mb-10">
        <img src="/fixed/about-1.png" class="mx-auto w-full max-w-full" alt="">
        <p class="font-bold">"Land Day", a Poster by the GUPW, 1977 </p>
        <p class="max-w-full sm:text-base">Issued by the General Union of Palestinian Women on Land Day in 1977, this poster shows a cubist painting by
            Palestinian artist Mona al-Saudi.</p>
    </div>

    <p class="smooth-content max-w-2xl mb-24 mx-auto sm:text-base sm:mb-10">As Palestinians growing up in a western country, we experienced a blend of
    ...
    <x-page-title class="smooth-content mb-12 content sm:text-3xl sm:mb-6">As devoted fashion enthusiasts, shopping was more than a pastime— it was a way
        to express love and bond with our family.
    </x-page-title>
    <p class="smooth-content max-w-2xl mx-auto mb-24 sm:text-base">Nearly a decade ago, we embarked on our journey towards a lifestyle free from
        animal
    ...
    <p class="smooth-content max-w-2xl mx-auto mb-24 sm:mb-10 sm:text-base">If being passionate consumers, immersed in the struggle to balance the desire for
    ...
    <x-page-title class="smooth-content mb-12 content sm:text-3xl sm:mb-6">Redefining Fashion with Creativity, Innovation, and a Deep Commitment to Ethics
        and Sustainability
    </x-page-title>
    <x-carousel/>
</main>
