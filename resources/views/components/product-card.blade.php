    ...
    <div class="aspect-square relative flex-1 mb-2 image-item group">
        @if($shopMode)
            ...
            <div
                ...
                window.Livewire.dispatch('addIdToCookie', { id: {{$product['id']}}, count: 1, price: {{$product['price']}} })"
                    ...
                    <svg id="product-basket-button-{{$product['id']}}" class="cart-button w-7 h-5" viewBox="0 0 17 18"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              ...
                              class="fill-red-700 dark:fill-bright-200 group-hover/svg:fill-red-700 group-hover/svg:dark:fill-bright-200 transition"/>
                    </svg>
                </div>
                <div
                ...
                window.Livewire.dispatch('addIdToWishlist', { id: {{$product['id']}}, price: {{$product['price']}} })"
                    ...
                    <svg id="product-wishlist-button-{{$product['id']}}" class="wishlist-button w-7 h-5" width="17"
        ...
        <a href="{{route('portal.product', $product['slug'])}}" wire:navigate>
            <img src="{{$product->getMedia('examples')->get(0)->getUrl()}}"
                 ...
                 alt="">
            @if($product->getMedia('examples')->get(1))
